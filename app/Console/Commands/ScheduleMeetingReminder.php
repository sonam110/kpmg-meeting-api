...
class ScheduleMeetingReminder extends Command
{
    ...
    public function handle()
    {
       ...
       $getAllmeetingAttendees = Attendee::join('meetings','meetings.id','attendees.meeting_id')->whereDate('meetings.metting_date',$currentNow)->orderby('meetings.id','ASC')->with('user:id,name,email')->get();
